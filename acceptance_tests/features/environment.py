...
def _purge_queues():
    with RabbitContext() as rabbit:
        rabbit.channel.queue_purge(queue=Config.RABBITMQ_INBOUND_REFUSAL_QUEUE)
        ...
        rabbit.channel.queue_purge(queue=Config.RABBITMQ_INBOUND_NOTIFY_FULFILMENT_REQUEST_QUEUE)
