...
from acceptance_tests.controllers.action_controller import create_action_plan, create_action_type, create_action_rule
...
def setup_action_rule(context, action_type, action_rule_delay):
    ...
    action_type_response_body = create_action_type(action_type_id, "ICL1E", "Census initial contact letter for England",
                                                   "Printer")

    action_type_url = action_type_response_body['_links']['self']['href']
    ...
    create_action_rule(str(uuid.uuid4()), trigger_date_time, classifiers, action_plan_url, action_type_url)
