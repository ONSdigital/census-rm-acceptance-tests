Feature: Telephone capture
  ...
  Scenario Outline: Generate and link correct QID type for unit level cases
    ...
    Examples:
      ...
      | sample_1_english_SPG_unit.csv  | SPG       | E            | 01                 |
      | sample_1_welsh_SPG_unit.csv    | SPG       | W            | 02                 |
      | sample_1_english_SPG_estab.csv | SPG       | E            | 01                 |
      | sample_1_welsh_SPG_estab.csv   | SPG       | W            | 02                 |
