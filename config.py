...
class Config:
    ...
    RABBITMQ_RH_OUTBOUND_CASE_QUEUE_TEST = 'case.rh.casetest'
    RABBITMQ_RH_OUTBOUND_UAC_QUEUE_TEST = 'case.rh.uactest'
    # RABBITMQ_OUTBOUND_FIELD_QUEUE_TEST = 'Action.FieldTest'
