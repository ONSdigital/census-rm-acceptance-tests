...
class Config:
    ...
    PUBSUB_EMULATOR_HOSTNAME = os.getenv("PUBSUB_EMULATOR_HOSTNAME", "pubsub-emulator")
    PUBSUB_EMULATOR_PORT = os.getenv('PUBSUB_EMULATOR_PORT', '8538')
    PUBSUB_EMULATOR_HOST = f'{PUBSUB_EMULATOR_HOSTNAME}:{PUBSUB_EMULATOR_PORT}'
