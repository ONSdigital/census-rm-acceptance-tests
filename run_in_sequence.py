...
from utilities.behave_utilities import create_behave_tags_argument, create_behave_show_skipped_tests_argument, \
    create_behave_log_level_argument, create_behave_format_argument, \
    create_behave_acceptance_feature_directory_argument, create_behave_stop_argument
...
def parse_arguments():
    ...
    # Create behave test command line arguments
